...
**1. Switch pin的定義為何** (switch pin上為1, 下為0)  
   ...
   **Pin[3:1]**: 當設定在Standalone下, 一開機要撥放的.out檔  
   ex.  
   011: 撥放LDSHOW3.out  
   010: 撥放LDSHOW2.out  
   000: 撥放LDSHOW0.out  
...
**2. 如何進入隨身碟模式**    
   斷電後, 把Pin[8:7]都切換成1, 再插上USB即可進入隨身碟模式. 這時打開檔案總管可看到一個名為LDUSB Vxx的槽.

**3. 如何進入Standalone模式**  
   斷電後, 把Pin[8:7]都切換成0, 再插上USB即可進入Standalone模式.
